...
class StoryBrain {
  ...
  void nextStory(int n) {
    if (_storyNum == 0 && n == 1)
      _storyNum = 2;
    else if (_storyNum == 0 && n == 2)
      _storyNum = 1;
    else if (_storyNum == 1 && n == 1)
      _storyNum = 2;
    else if (_storyNum == 2 && n == 1)
      _storyNum = 5;
    else if (_storyNum == 2 && n == 2)
      _storyNum = 4;
    else if (_storyNum == 1 && n == 2)
      _storyNum = 3;
    else if (_storyNum == 3 || _storyNum == 4 || _storyNum == 5) restart();
  }
